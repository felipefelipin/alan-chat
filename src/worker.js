    ...
    return withChatLock(chatId, async () => {
      ...
      if (type === "POST_PAYMENT_GRUPO_VIP") {
        ...
        if (!GROUP_CHAT_ID) {
          ...
          // GROUP_CHAT_ID ser configurado.
          console.warn(`[grupo-vip] GROUP_CHAT_ID não configurado — convidar manualmente: chatId ${chatId}`);
        ...
        try {
          const invite = await bot.createChatInviteLink(GROUP_CHAT_ID, { member_limit: 1 });
          await bot.sendMessage(chatId,
